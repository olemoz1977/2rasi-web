# WorkStyle 15 — v0.1 LT item bank

Status: PRE-PILOT / ORIGINAL WORKSTYLE CONTENT
...
The item wording below is original WorkStyle 15 content. It is designed for workplace self-reflection, not diagnosis or personnel selection.
...
# Pre-pilot checks still required

1. Cognitive/language review with several real users.
2. Cross-loading review after the construct remap.
3. Verify that reverse items are interpreted naturally rather than as traps.
4. Check whether Social Energy remains distinct from Persuasive Influence and Assertive Communication.
5. Check whether Constructive Outlook remains distinct from Emotional Regulation.
6. Check whether Achievement Drive remains distinct from Goal Persistence.
7. Freeze item wording/version only after this review.
