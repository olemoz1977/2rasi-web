# WorkStyle 15 — v0.3 LT item bank

Status: PRE-PILOT / POST-TWO-REVIEW CONSENSUS
...
The wording below is original WorkStyle 15 content for workplace self-reflection. It is not a diagnostic instrument and is not intended for automated personnel decisions.

V0.3 preserves the v0.2 architecture and targeted Claude revisions, and incorporates four additional low-risk wording refinements independently identified in the second blind review.
...
**SYS-01 · D** Spręsdamas problemą ieškau priežasčių, kurios ją sukėlė arba palaiko.
...
**INF-01 · D** Pristatydamas savo idėją, argumentus formuluoju taip, kad kiti matytų, kodėl ją verta palaikyti.
...
These are theoretical scale indexes, not percentiles and not comparisons with other people.

# Pre-pilot empirical watch list
...
4. Learning Orientation vs Reflective Self-Awareness after the LRN-01 rewrite.
5. Ceiling/floor compression and social-desirability patterns.
...
V0.1 remains preserved as the first blind-review baseline.
V0.2 preserves the first-review revision set.
V0.3 is the candidate item bank after two independent blind reviews and is the preferred basis for final Lithuanian cognitive/language review and pilot implementation.
